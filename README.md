...
Cycle: You pass the object to analysis functions (Green), which add
layers of information (stats, biology) and return the updated object.

Output: At any point, you can generate reports or visualizations
(Purple) based on the current state of the object.
